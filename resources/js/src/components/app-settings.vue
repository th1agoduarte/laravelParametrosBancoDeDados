    ...
    <div>
        ...
        <div class="app-settings" :class="{ active: isOpen }">
            ...
            <perfect-scrollbar class="sidbarchat p-3" tag="div">
                ...
                <h5 class="mb-0 text-center">WORK AREA CUSTOMIZATION</h5>
                <p class="text-center">Configure your Settings.</p>
                <hr />

                <h6 class="mb-1">Color scheme</h6>
                <p class="small text-muted mb-3">Light or dark general presentation.</p>
                ...
                <p class="small text-muted mb-3">Select the primary navigation orientation for your app.</p>
                <div class="btn-group-toggle row mb-4 mx-0">
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
